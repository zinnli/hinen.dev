...
<img
  src="https://img1.daumcdn.net/thumb/R1280x0/?scode=mtistory2&fname=https%3A%2F%2Fblog.kakaocdn.net%2Fdn%2FszV78%2FbtrB7cQlwoM%2FQ1LNIjjlIfrMSMBHIPKUpk%2Fimg.png"
  alt="recoil1"
  width="300"
/>
<img
  src="https://img1.daumcdn.net/thumb/R1280x0/?scode=mtistory2&fname=https%3A%2F%2Fblog.kakaocdn.net%2Fdn%2FH8T4T%2FbtrB6vpQaUZ%2FfcYy5A5FWm5YLcY60vPbhK%2Fimg.png"
  alt="recoil2"
  width="400"
/>
<img
  src="https://img1.daumcdn.net/thumb/R1280x0/?scode=mtistory2&fname=https%3A%2F%2Fblog.kakaocdn.net%2Fdn%2FbcK1rz%2FbtrB7MRVlf1%2FNn538rbblsupNIrW7VXbm1%2Fimg.png"
  alt="recoil3"
  width="400"
/>
...
- **Atoms**
  ...
  - key와 default값을 필수로 선언해줘야함 - key : 내부적으로 atom을 식별하는 데 사용되는 고유한 문자열<br/>전역적으로 고유한 값을 가져야 하므로 네이밍 시 $와 같은 구분자를 붙여 사용하기도 함 - default : atom의 초깃값<br/>다양한 타입을 사용할 수 있으며, 동일한 타입의 값을 나타내는 다른 atom이나 selector도 가능함
...
[Recoil 공식문서](https://recoiljs.org/ko/docs/basic-tutorial/atoms)

[Recoil: React를 위한 상태 관리 라이브러리](https://wit.nts-corp.com/2022/10/13/6586)

[Recoil 비동기통신(Suspense, Loadable)](https://velog.io/@qnrl3442/Recoil-%EB%B9%84%EB%8F%99%EA%B8%B0%ED%86%B5%EC%8B%A0Suspense-Loadable)

[React-boilerplate란?](https://velog.io/@blackeichi/React-boilerplate%EB%9E%80)

[recoil과 비동기 데이터 호출 (+ 선언적 프로그래밍)](https://leego.tistory.com/entry/recoil%EA%B3%BC-%EB%B9%84%EB%8F%99%EA%B8%B0-%EB%8D%B0%EC%9D%B4%ED%84%B0-%ED%98%B8%EC%B6%9C-%EC%84%A0%EC%96%B8%EC%A0%81-%ED%94%84%EB%A1%9C%EA%B7%B8%EB%9E%98%EB%B0%8D)
