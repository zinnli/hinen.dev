---
title: WIL | 넘블 챌린지와 깃블로그 이슈
date: 2023-06-04
desc: 넘블 챌린지 후기와 겪은 오류들
---
...
- **배포 시 HTTP 요청이 HTTPS 로 넘어가는 부분**
  - 문제
  - 해결
- [링크](https://github.com/zinnli/dating-app/blob/main/src/apis/axios.ts#L11)
...
- **파일 구조**
  - components 하위에 domain 라는 이름의 폴더가 어색함 [링크](https://github.com/zinnli/dating-app/tree/main/src/types)
- **React Query**
  - [링크](https://github.com/zinnli/dating-app/blob/main/src/App.tsx#L8)
  ...
  - [링크](https://github.com/zinnli/dating-app/blob/main/src/pages/Register.tsx#L68)
...
- **suspense, error boundary**
  ...
  - [링크](https://fe-developers.kakaoent.com/2022/221110-error-boundary/)
- **styled component**
  - 페이지에 대한 styled component 코드는 분리하는 것이 좋음
  - [링크](https://github.com/zinnli/dating-app/blob/main/src/pages/Mypage.tsx#L46)
...
[링크](https://fe-developers.kakaoent.com/2022/221110-error-boundary) 여기에 있는 코드를 참고해서 하고 있는데, axios error의 경우 이전에 하던 프로젝트는 서버가 다 내려가있는 상태다보니 확인하기 어려울 것 같아서 이후에 프로젝트 하나 더 만들어서 진행해보려고 생각중이다.<br/>
