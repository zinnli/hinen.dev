---
title: WIL | styled-components, 프로젝트 이슈 수정 및 theme 사용하기
date: 2023-05-14
desc: styled-components, 프로젝트 이슈 수정 및 theme 사용하기
---

## **이번주 한 일**

- styled-components 오류 해결
- theme 사용하기
- 프로젝트 설정 이슈 해결
...
[[에러 해결] styled-components Could not find
declarationfile](https://garniel23.tistory.com/m/entry/%EC%97%90%EB%9F%AC-%ED%95%B4%EA%B2%B0-styled-components-Could-not-find-declaration-file)  
[[TIL] styled-components 공통 스타일 속성을 typescript로
세팅하기](https://velog.io/@perfumellim/TIL-styled-components-%EA%B3%B5%ED%86%B5-%EC%8A%A4%ED%83%80%EC%9D%BC-%EC%86%8D%EC%84%B1%EC%9D%84typescript%EB%A1%9C-%EC%84%B8%ED%8C%85%ED%95%98%EA%B8%B0)  
[선언병합을 활용하여 CSS in JS의 theme
타입추론하기](https://happysisyphe.tistory.com/50)
